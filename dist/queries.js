export const getTasks = "SELECT tasks.task_id, tasks.task_name, tasks.task_description, tasks.task_asignee, tasks.task_status, tasks.task_priority, tasks.start_date, tasks.due_date, tasks.created_at, tasks.updated_at, projects.project_name, projects.project_description FROM tasks JOIN projects ON tasks.project_id = projects.project_id WHERE task_status != 'Completed'";
