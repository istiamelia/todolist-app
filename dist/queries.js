export const getTasks = "SELECT * FROM tasks WHERE completed = false AND deleted_at IS NULL";
export const getCompletedTasks = "SELECT * FROM tasks WHERE completed = true AND deleted_at IS NULL";
...
export const addTasks = "INSERT INTO tasks (id, title, completed) VALUES ($1, $2, $3)";
...
export const deleteAllTasks = "UPDATE tasks SET deleted_at = NOW() WHERE completed = false";
